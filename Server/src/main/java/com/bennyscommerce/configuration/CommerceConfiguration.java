...
public class CommerceConfiguration {
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 5, 10)).nomeArticolo("Mouse Wireless").img(
		"https://cdn.discordapp.com/attachments/1062713292226830409/1222589317713629286/M1-removebg-preview.png?ex=6616c407&is=66044f07&hm=5e9885dcc01907c0eb537b91e7c93c5c212e7193f9f78f0e90eb7cdafd6604f1&")
		.brand("Logitech")
		.descrizioneArticolo(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 5, 10)).nomeArticolo("Mouse Cablato").img(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 9, 13)).nomeArticolo("Mouse Wireless").img(
		"https://cdn.discordapp.com/attachments/1062713292226830409/1222590371608006716/M3-removebg-preview.png?ex=6616c503&is=66045003&hm=3eb04c2b192c8d47aa0dfd2d4ef9c6ea2e2d39a26b9e2d4fa4823da619408e01&")
		.brand("TECKNET PRO")
		.descrizioneArticolo(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 10, 20)).nomeArticolo("Mouse Cablato").img(
		"https://cdn.discordapp.com/attachments/1062713292226830409/1222590705747234827/M4-removebg-preview.png?ex=6616c552&is=66045052&hm=f12216fd9fb4c63f19550fbd276789812f00685de5f118097c22157ad2835659&")
		.brand("Trust Verto")
		.descrizioneArticolo(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 8, 15)).nomeArticolo("Mouse Wireless").img(
		"https://cdn.discordapp.com/attachments/1062713292226830409/1222591025453858846/M5-removebg-preview.png?ex=6616c59f&is=6604509f&hm=aebdf5822dbc8a5d8aabc515dc847cd5c25446e0ddb1849c93331b634c08c3b8&")
		.brand("Anmck")
		.descrizioneArticolo(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 5, 10)).nomeArticolo("Mouse Wireless").img(
		"https://cdn.discordapp.com/attachments/1062713292226830409/1222591333219176618/M6-removebg-preview.png?ex=6616c5e8&is=660450e8&hm=672a973cb7c3f901f85474ff1600a4c307660b04e1c1c06329ccdd205de42a53&")
		.brand("Trust")
		.descrizioneArticolo(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 10, 20)).nomeArticolo("Mouse Wireless").img(
		"https://cdn.discordapp.com/attachments/1062713292226830409/1222591538886873098/M7-removebg-preview.png?ex=6616c619&is=66045119&hm=e90785735893f896e2aeb21bde8f66811cad1c9a12dd839b3775cdfdcb6be3b5&")
		.brand("Uiosmuph")
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 5, 10)).nomeArticolo("Mouse Wireless").img(
		"https://cdn.discordapp.com/attachments/1062713292226830409/1222591758970654720/M8-removebg-preview.png?ex=6616c64d&is=6604514d&hm=c066d37b30fd60f1670ec97d98a8c2576b224a9d20cb8d3d56733654bdf1314e&")
		.brand("Glorious")
		.descrizioneArticolo(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 120, 180)).nomeArticolo("Monitor").img(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 500, 700)).nomeArticolo("Monitor").img(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 1000, 1300)).nomeArticolo("Monitor").img(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 60, 100)).nomeArticolo("Keyboard").img(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 20, 40)).nomeArticolo("Keyboard").img(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 20, 30)).nomeArticolo("Keyboard").img(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 100, 120)).nomeArticolo("Keyboard").img(
	...
	return Articoli.builder().prezzo(fake.number().randomDouble(2, 100, 300)).nomeArticolo("Keyboard").img(
