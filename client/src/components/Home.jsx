    ...
    <>
      <div className={`mt-5 ${light ? "nero" : "bianco"} }`}>
        <ScrollContainer>
              ...
              <div className="d-flex flex-column align-items-center">
                <div className="blocco-divisione d-flex justify-content-around position-relative">
                  ...
                  <div className="d-flex flex-column justify-content-around align-items-center">
                    <h2>MOUSE</h2>
                    <img src={articolo[2].img} alt="Icona mouse" width={"300px"} height={"240px"} />
                  ...
                  <div className="d-flex flex-column justify-content-around align-items-center">
                    <h2>TASTIERA</h2>
                    <img src={articolo[23].img} alt="icona-tastiera" width={"300px"} height={"240px"} />
                    <div className="d-flex flex-column align-items-center justify-content-center mt-5">
                      <span class="arrow"></span>
          ...
          <ScrollPage>
            <Animator animation={batch(StickyOut(), ZoomOut(0, 10))}>
          ...
          <ScrollPage>
            <Animator animation={batch(FadeOut(), ZoomOut(), MoveOut())}>
              <div className="d-flex flex-column align-items-center">
                <div
                  style={{
                ...
                >
                  <h1 className="text-center my-5 titoloGrande">PREVIEW MOUSE</h1>
                  {currentStep === 1 && (
                    <div className="d-flex justify-content-around align-items-center">
                      ...
                      <div>
                        <div className="d-flex flex-column align-items-center justify-content-center">
                          ...
                          <a>
                            <button onClick={handleNextStep} className="bn632-hover bn20">
                              AVANTI
                              <span className="ms-3">
                                <GrLinkNext />
                              </span>
                  ...
                  {currentStep === 2 && (
                    <div className="d-flex justify-content-around align-items-center mt-5">
                      ...
                      <div>
                        ...
                        <a>
                          <button onClick={handlePreviousStep} className="bn632-hover bn20">
                            <span className="me-3">
                              <IoArrowBackOutline />
                            </span>
                            INDIETRO
          ...
          <ScrollPage>
            <Animator animation={batch(FadeOut(), ZoomOut(), MoveOut())}>
              <div className="d-flex flex-column align-items-center">
                ...
                >
                  <h1 className="text-center my-5 titoloGrande">PREVIEW MONITOR</h1>
                  {currentStep === 1 && (
                    <div className="d-flex justify-content-around align-items-center">
                      <img
                        className="img-custom"
          ...
          <ScrollPage>
            <Animator animation={batch(Fade())}>
              <div className="d-flex flex-column align-items-center">
                ...
                >
                  <h1 className="text-center my-5 titoloGrande">PREVIEW TASTIERE</h1>
                  {currentStep === 1 && (
                    <div className="d-flex justify-content-around align-items-center">
                      <img
                        className="img-custom"
