...
const Home = ({ light }) => {
  ...
  return (
    <>
      <div
        className={`mt-5 contenitoreHome ${light ? "white-mod" : "dark-mod"} }`}
      >
        <ScrollContainer>
          <ScrollPage>
            <Animator animation={batch(Fade(), MoveOut(0, -200))}>
              <h1 className="my-5 fw-bolder text-center titoloGrande">
                PREVIEW ARTICOLI
              </h1>
          ...
          <ScrollPage>
            ...
            >
              <img
                src="https://i.postimg.cc/gkfWZb1T/output-onlinegiftools-2.gif"
                alt="Mouse icona"
                width={"500px"}
              />
            </Animator>
                ...
                <div className="div-specifiche">
                    ...
                    <div className="d-flex justify-content-around align-items-center">
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        <h4 className="fw-bold">
                          Il nostro sensore più preciso per il gaming
                        </h4>
                        <span></span>
                        <p>
                          I professionisti degli eSport puntano sempre a una
                          velocità e una precisione maggiori, così come Logitech
                          G. Con l'invenzione di HERO 25K, il sensore per il
                          gaming di ultima generazione, il mondo ha ora un nuovo
                          leader. In PRO Wireless, HERO 25K è stato ottimizzato
                          per tracciare movimenti assurdi a velocità superiori a
                          400 IPS senza perdere un colpo. HERO 25K offre
                          prestazioni di punta a qualsiasi sensibilità senza
                          smoothing, accelerazione o filtraggio da 100 a 25.600
                          DPI. HERO 25K, inoltre, consuma 10 volte meno energia
                          rispetto ai predecessori, come PMW3366, consentendo di
                          utilizzare una batteria più leggera e di maggiore
                          durata. I professionisti vogliono il meglio, vogliono
                          HERO 25K.
                        </p>
                      </div>
                  ...
                  {specificheMouse === 2 && (
                    <div className="d-flex justify-content-between align-items-center">
                      <div
                        onClick={specificheMousePreviousStep}
                        className="button"
                      >
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        ...
                        <span></span>
                        <p>
                          Per i professionisti, è fondamentale liberarsi del
                          cavo che produce attriti e distrazioni inaccettabili
                          negli eSport professionali. Questa innovativa
                          tecnologia wireless end-to-end supera le limitazioni
                          di latenza, connettività e potenza per offrire una
                          connessione costante, senza ritardi e con una
                          frequenza di aggiornamento di 1 ms. Senza cavo.
                        </p>
                      </div>
                      <div className="img">
                        <img
                  ...
                  {specificheMouse === 3 && (
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        ...
                        <span></span>
                        <p>
                          Il design del più recente endoscheletro di Logitech G
                          raggiunge il peso irreale di 80 grammi. Il guscio
                          esterno incredibilmente sottile, fino a 1 mm, sfrutta
                          un'innovativa struttura a scala per la massima
                          resistenza e il supporto durante i tornei.
                          <br />
                          <br />
                          L'avanzata batteria ai polimeri di litio è
                          straordinariamente duratura e leggera per un gaming
                          wireless senza problemi né preoccupazioni. Ricarica
                          prima di un torneo e puoi dimenticarti della batteria
                  ...
                  {specificheMouse === 4 && (
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        ...
                        <span></span>
                        <p>
                          I pulsanti laterali sinistro e destro rimovibili
                          rendono PRO Wireless realmente ambidestro e consentono
                          ai professionisti di decidere quanti pulsanti laterali
                          utilizzare, da zero a quattro. Il pulsante DPI è
                          collocato nella parte inferiore del mouse per evitare
                          le modifiche di DPI non volontarie durante il gioco.
                          Logitech G PRO Wireless Gaming Mouse è subito pronto
                          per l'uso con le impostazioni predefinite per i
                          pulsanti, che puoi anche personalizzare completamente
                          in base alle tue preferenze con Logitech G HUB.
                        </p>
                      </div>
                      <div className="img">
                        <img
                  ...
                  {specificheMouse === 5 && (
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        ...
                        <span></span>
                        <p>
                          PRO Wireless è offre una personalizzazione di circa
                          16,8 milioni di colori1, perfetta per rappresentare i
                          colori della tua squadra, adattare la configurazione o
                          sincronizzarsi con altri prodotti G. LIGHTSYNC offre
                          inoltre effetti di illuminazione basati sul gioco che
                          rispondono all'azione di gioco, alla visualizzazione
                          dell'audio, al campionamento dei colori dello schermo
                          e altro ancora. Programma tutto con G HUB.
                        </p>
                      </div>
                      <div onClick={specificheMouseNextStep} className="button">
                        <GrLinkNext className="icona" />
                  ...
                  {specificheMouse === 6 && (
                    <div className="d-flex justify-content-evenly align-items-center">
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        <h4 className="fw-bold">
                          Sistema meccanico di tensionamento dei pulsanti
                        </h4>
                        <span></span>
                        <p>
                          PRO Wireless è dotato della più recente tecnologia dei
                          pulsanti principali. Grazie a una molla metallica per
                          tendere le piastre separate per il pulsante destro e
                          sinistro, la distanza di spostamento e la forza di
                          attuazione (la forza necessaria al clic) sono state
                          ridotte e perfezionate. Ogni clic offrirà una
                          sensazione tattile incredibilmente precisa, costante e
                          definita.
                        </p>
                      </div>
                    </div>
                  ...
                  {previewMouse === 2 && (
                    <div className="d-flex justify-content-around align-items-center mt-5">
                      ...
                      <div>
                        ...
                        <a>
                          <button
                            onClick={previewMousePreviousStep}
                            className="bn632-hover bn20"
                          >
                            <span className="me-3">
                              <IoArrowBackOutline />
          ...
          <ScrollPage>
            ...
            >
              <div className="d-flex justify-content-center">
                <img
                  src="https://i.postimg.cc/ZnVLzjZk/output-onlinegiftools.gif"
                  alt="monitor Pic"
                />
              </div>
            </Animator>
              ...
              <div className="d-flex flex-column align-items-center">
                <div className="div-specifiche">
                  ...
                  {specificheMonitor === 1 && (
                    <div className="d-flex justify-content-around align-items-center">
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        ...
                        <span></span>
                        <p>
                          La curvatura 1000R, l’ultima frontiera della
                          tecnologia dei monitor curvi, si adatta ai contorni
                          dell’occhio umano per un realismo inimmaginabile.
                        </p>
                      </div>
                      <div
                        onClick={specificheMonitorNextStep}
                        className="button"
                      >
                        <GrLinkNext className="icona" />
                      </div>
                  ...
                  {specificheMonitor === 2 && (
                    <div className="d-flex justify-content-between align-items-center">
                      <div
                        onClick={specificheMonitorPreviousStep}
                        className="button"
                      >
                        <GrLinkPrevious className="icona" />
                      </div>
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        ...
                        <span></span>
                        <p>
                          QLED, HDR600 e risoluzione WQHD, insieme per dare vita
                          a colori spettacolari con un eccezionale livello di
                  ...
                  {specificheMonitor === 3 && (
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        ...
                        <span></span>
                        <p>
                          L’elegante pannello esterno in nero opaco presenta, al
                          centro, un accattivante inserto luminoso di richiamo
                          futuristico.
                        </p>
                      </div>
                      <div
                  ...
                  {specificheMonitor === 4 && (
                    <div className="d-flex justify-content-evenly align-items-center">
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        ...
                        <span></span>
                        <p>
                          240Hz RapidCurve, tempo di risposta di 1 ms e
                          compatibilità G-Sync per conquistare la vetta della
                          classifica.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-around align-items-center">
                      ...
                      <div>
                        <div className="d-flex flex-column align-items-center justify-content-center">
                          ...
                          <button
                            onClick={previewMonitorNextStep}
                            className="bn632-hover bn20"
                          >
                            AVANTI
                            <span className="ms-3">
                  ...
                  {previewMonitor === 2 && (
                    <div className="d-flex justify-content-around align-items-center mt-5">
                      ...
                      <div>
                        ...
                        <a>
                          <button
                            onClick={previewMonitorPreviousStep}
                            className="bn632-hover bn20"
                          >
                            <span className="me-3">
                              <IoArrowBackOutline />
            ...
            <Animator animation={batch(Fade(), MoveOut(0, -50))}>
              <div className="d-flex flex-column align-items-center">
                <div className="div-specifiche">
                  ...
                  {specificheTastiera === 1 && (
                    <div className="d-flex justify-content-around align-items-center">
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        ...
                        <span></span>
                        <p>
                          Ti dà una sensazione ancora migliore quando giochi o
                          digita quel rapporto KPI che era dovuto la scorsa
                          settimana.
                        </p>
                      </div>
                      <div
                        onClick={specificheTastieraNextStep}
                        className="button"
                      >
                        <GrLinkNext className="icona" />
                      </div>
                  ...
                  {specificheTastiera === 2 && (
                    <div className="d-flex justify-content-between align-items-center">
                      <div
                        onClick={specificheTastieraPreviousStep}
                        className="button"
                      >
                        <GrLinkPrevious className="icona" />
                      </div>
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        ...
                        <p>
                          <span className="fw-bold">
                            Costruzione di alluminio
                          </span>
                          <br />
                          La costruzione in metallo in alluminio massiccio
                          mentre pesa 420 grammi di piume garantisce durata e
                          portabilità.
                          <br />
                          <br />
                          <span className="fw-bold">
                            L'acustica ottimizzata
                          </span>
                          <br />
                          Abbiamo aggiunto un ulteriore livello di schiuma di
                          smorzamento del suono per aiutare con l'acustica
                          complessiva della tastiera.
                          <br />
                          <br />
                          <span className="fw-bold">
                            Stabilizzatori lubrificati personalizzati
                          </span>
                          <br />I nostri stabilizzatori personalizzati vengono
                          pre-lubrificati, riducendo il suono e le incongruenze,
                          migliorando l'acustica della tastiera.
                        </p>
                      </div>
                      <div className="img">
                        <img
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        ...
                        <p>
                          ...
                          <br />
                          16,8 milioni di colori tra cui scegliere.
                          Personalizzabile nel software OP e salvato
                          direttamente nello storage di bordo. Due LED di spazio
                          extra che fiancheggiano i lati dell'interruttore.
                          <br />
                          <br />
                          <span className="fw-bold">Meno keycap, più luce</span>
                          <br />
                          Il profilo di keycap personalizzato progettato da
                          FNATIC espelle più illuminazione dal lato
                          dell'interruttore e lo diffonde su tutta la tastiera
                          per illuminare l'allestimento della scrivania.
                        </p>
                      </div>
                      <div
                        onClick={specificheTastieraNextStep}
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        ...
                        <p>
                          ...
                          <br />
                          Arrivando a un totale di 1,8 metri di lunghezza, il
                          cavo esterno intrecciato siederà abbastanza sulla
                          scrivania riducendo al minimo il disordine del cavo
                          grazie alla bobina ben imballata, ma estensibile da 16
                          centimetri.
                          <br />
                          <br />
                          <span className="fw-bold">È semplice come A a C</span>
                          <br />E a differenza di alcune altre aziende che sono
                          ancora bloccate in passato, sappiamo cosa vogliono le
                          persone, quindi ovviamente il nostro cavo di
                          alimentazione ha connettori USB-A USB-C standard e non
                          proprietari.
                        </p>
                      </div>
                      <div
                  ...
                  {specificheTastiera === 5 && (
                    <div className="d-flex justify-content-evenly align-items-center">
                      ...
                      <div className="d-flex flex-column justify-content-center paragrafo">
                        <h4 className="fw-bold">
                          Basso profilo degli switches
                        </h4>
                        <span></span>
                        <p>
                          <span className="fw-bold">
                            L'ultimo interruttore eSports
                          </span>
                          <br />
                          Dotato di interruttori a basso profilo FNATIC,
                          l'SREAK65 LP offre la massima velocità con un
                          pre-viaggio da 1,0 mm. Ciò offre una battitura fluida
                          e impeccabile quando si gioca, consentendo di
                          concentrarsi sulle prestazioni.
                          <br />
                          <br />
                          <span className="fw-bold">
                            Ergonomia di commutazione perfezionata
                          </span>
                          <br />
                          L'interruttore FNATIC a basso profilo è inferiore del
                          35% rispetto agli interruttori meccanici tradizionali.
                          L’altezza dei tasti è ridotta, consentendo una
                          posizione del polso più sana e naturale, anche senza
                          l’uso di un poggiapolsi.
                        </p>
                      </div>
                    </div>
                  )}
                    ...
                    <div className="d-flex justify-content-around align-items-center">
                      ...
                      <div>
                        <div className="d-flex flex-column align-items-center justify-content-center">
                          ...
                          <a>
                            <button
                              onClick={previewTastieraNextStep}
                              className="bn632-hover bn20"
                            >
                              AVANTI
                              <span className="ms-3">
                  ...
                  {previewTastiera === 2 && (
                    <div className="d-flex justify-content-around align-items-center mt-5">
                      ...
                      <div>
                        ...
                        <a>
                          <button
                            onClick={previewTastieraPreviousStep}
                            className="bn632-hover bn20"
                          >
                            <span className="me-3">
                              <IoArrowBackOutline />
